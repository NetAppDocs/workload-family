...
For technical support related to a cloud provider file service, its infrastructure, or any solution using the service, refer to "Getting help" in the Workload Factory documentation for that product.
...
To use the *Create a Case* capability, you must first associate your NetApp Support Site credentials with your Workload Factory login. https://docs.netapp.com/us-en/workload-setup-admin/task-manage-user-credentials.html[Learn how to manage credentials associated with your Workload Factory login^].
...
. In Workload Factory, select *Help > Support*.
...
+
* *Service*: Select the service that the issue is associated with. For example, Workload Factory when specific to a technical support issue with workflows or functionality within the service.
